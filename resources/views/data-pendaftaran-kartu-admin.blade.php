    ...
    <form action="/update-registration/{{ $viewData->id_pendaftaran }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-xl-12">
            <div class="card card-body" id="cetak" style="margin-bottom: -1rem">
                <div class="p-4">
                    <div class="d-flex">
                        <div class="col-lg-2" style="text-align: center; margin-right:25px; margin-left:25px;">
                        ...
                        <div class="col-lg-6">
                            <center>
                                ...
                                <h5 style="margin-top: -0.5rem"> <strong class="d-block">PENERIMAAN MAHASISWA BARU</strong></h4>
                                    <h4 style="margin-top: -0.5rem"><strong class="d-block">UNIVERSITAS BIBIT UNGGUL</strong></h3>
                                        <p style="margin-top: -0.5rem"><strong class="d-block">Jalan Penuh berkah, desan berbagi sedekah <br> 41152</strong></p>
                            </center>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-4" style="border-top: 2px solid black!important; margin-top:-2.5rem;">
                        <div class="d-flex">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3 mb-4">
                                    ...
                                    <h5 style="text-indent: 0.5in"><strong>{{ $viewData->tempat_lahir }}, {{ $viewData->tanggal_lahir }}</strong></h5>
                                </div>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <h5 style="text-indent: 0.5in;text-align: justify;">Saya yang menyatakan bahwa data yang
                                saya isikan dalam formulir pendaftaran penerimaan mahasiswa baru Universitas Bibit Unggul tahun 2024 adalah benar dan saya bersedia menerima ketentuan yang berlaku. Saya
                        ...
                        <div class="d-flex">
                            ...
                            <div class="col-lg-6" style="width:50%;">
                                <br>
                                <center>
                                    <h5><label class="form-label"><strong class="d-block">...............................,2022</strong></label>
                                    </h5>
                                    <br>
        ...
        <div class="row my-4">
            <div class="col">
                <div class="text-end mt-2 mt-sm-0">
                    <button class="btn btn-success waves-effect waves-light me-1" onclick="printDiv('cetak')"><i class="fa fa-print"> </i></button>
                </div>
            </div>
            <!-- end col -->
        </div>
