            ...
            <div class="card card-body">
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target=".upload" style="margin-bottom: 1rem;"><i class="mdi mdi-plus me-1"></i>Upload Pembayaran</button>
                        @endif
                        @endforeach

                        <button class="btn btn-success mb-4" style="margin-bottom: 1rem;" disabled>Terverifikasi</button>
                        <a href="../../card-registration/{{$viewData->id_pendaftaran}}"><button type="button" class="btn btn-primary mb-4">View Card </button></a>
                ...
                <div class="modal fade upload" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form action="../upload-payment" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="id_pendaftaran" id="nama" class="form-control" value="{{ $viewData->id_pendaftaran }}">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-file">
                                                        <input type="file" class="form-file-input form-control" name="pem">
                                                        <input type="hidden" class="form-file-input form-control" name="pathnya">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
