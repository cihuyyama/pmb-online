                    ...
                    <div id="personal-data" class="collapse show">
                        <div class="p-4 border-top">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        @if ($x->Nama != null)
                                        <input type="text" class="form-control" id="basicpill" name="nama" placeholder="Masukkan Nama Lengkap" value="{{ $x->Nama }}">
                                        @else
                                        <input type="text" class="form-control" id="personal-data-name" name="nama" placeholder="Masukkan Nama Lengkap" value="{{ old('nama') }}">
                                        @endif
                                        @error('nama')
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-nik">Kewarganegaraan</label>
                                        <select class="form-control wide" name="kewarganegaraan" value="{{ old('nik') }}">
                                            <option value="{{ old('nik') }}" disabled selected>Pilih Warga Negara</option>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-4 mb-lg-0">
                                        ...
                                        <input type="text" class="form-control" id="basicpill" name="tempatlahir" placeholder="Masukkan Tempat Lahir" value="{{ $x->Tempat_lahir }}">
                                        @else
                                        <input type="text" class="form-control" id="basicpill" name="tempatlahir" placeholder="Masukkan Tempat Lahir" value="{{ old('tempatlahir') }}">
                                        @endif
                                        @error('tempatlahir')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-4 mb-lg-0">
                                        ...
                                        <input type="date" class="form-control" id="basicpill" name="tanggallahir" placeholder="Masukkan Tanggal Lahir" value="{{ $x->Tanggal_lahir }}">
                                        @else
                                        <input type="date" class="form-control" id="basicpill" name="tanggallahir" placeholder="Masukkan Tanggal Lahir" value="{{ old('tanggallahir') }}">
                                        @endif
                                        @error('tanggallahir')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                            ...
                            <div class="mb-4">
                                ...
                                @if ($x->Alamat != null)
                                <textarea class="form-control" id="billing-address" rows="3" name="alamat" placeholder="Masukkan alamat lengkap">{{ $x->Alamat }}</textarea>
                                @else
                                <textarea class="form-control" id="billing-address" rows="3" name="alamat" placeholder="Masukkan alamat lengkap">{{ old('alamat') }}</textarea>
                                @endif
                                @error('alamat')
                                <div class="alert alert-warning" role="alert">
                                    <strong>Peringatan!</strong>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="email" class="form-control" id="personal-data-nisn" name="email" placeholder="Masukkan email" value="{{ auth()->user()->email }}" readonly>
                                        @error('email')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-nik">No
                                            Hp/WhatsApp</label>
                                        @if ($x->No_Hp != null)
                                        <input type="number" class="form-control" id="basicpill" name="nohp" placeholder="Masukkan Tanggal Lahir" value="{{ $x->No_Hp }}">
                                        @else
                                        <input type="number" class="form-control" id="basicpill" name="nohp" placeholder="Masukkan nomor telepon" value="{{ old('nohp') }}">
                                        @endif
                                        @error('nohp')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                        ...
                        <div class="p-4 border-top">
                            <div class="mb-4">
                                ...
                                <select class="form-control wide" name="gelombang">
                                    ...
                                    @endforeach
                                    <option value="Gelomabng 1" selected>Gelomabng 1</option>
                                    <option value="Gelomabng 2">Gelomabng 2</option>
                                </select>
                                @error('gelombang')
                                <div class="alert alert-warning" role="alert">
                                    <strong>Peringatan!</strong>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-nisn">Pilihan
                                            1</label>
                                        <input class="form-control" list="datalistOptionsProdi" id="exampleDataList" placeholder="Pilih program studi" name="pil1" value="{{ old('pil1') }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input class="form-control" list="datalistOptionsProdi" id="exampleDataList" placeholder="Pilih program studi" name="pil2" value="{{ old('pil2') }}">
                                        <datalist id="datalistOptionsProdi">
                                            @foreach ($viewProdi as $z)
                                            <option value="{{ $z->id_prodi }}">{{ $z->nama_prodi }}
                                            </option>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-name">Nama
                                            Ayah</label>
                                        <input type="text" class="form-control" id="personal-data-name" name="ayah" placeholder="Masukkan Nama Ayah" value="{{ old('ayah') }}">
                                        @error('ayah')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-gender">Pekerjaan
                                            Ayah</label>
                                        <input class="form-control" list="datalistOptionsOccupation" id="exampleDataList" placeholder="Masukkan Jenis Pekerjaan..." name="pekerjaanayah" value="{{ old('pekerjaanayah') }}">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-nik">No HP
                                            Ayah</label>
                                        <input type="number" class="form-control" id="personal-data-no" name="noayah" placeholder="Masukkan Telepon Ayah" value="{{ old('noayah') }}">
                                        @error('pekerjaanayah')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="text" class="form-control" id="personal-data-name" name="ibu" placeholder="Masukkan Nama Ibu" value="{{ old('ibu') }}">
                                        @error('ibu')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-gender">Pekerjaan
                                            Ibu</label>
                                        <input class="form-control" list="datalistOptionsOccupation" id="exampleDataList" placeholder="Cari Pekerjaan Ibu.." name="pekerjaanibu" value="{{ old('pekerjaanibu') }}">
                                        <datalist id="datalistOptionsOccupation">
                                            <option value="Karyawan Swasta"></option>
                                            <option value="Karyawan BUMN"></option>
                                            <option value="Karyawan BUMD"></option>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-nik">No Telepon
                                            Ibu</label>
                                        <input type="number" class="form-control" id="personal-data-no" name="noibu" placeholder="Masukkan Telepon Ibu" value="{{ old('noibu') }}">
                                        @error('noibu')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-2">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="personal-data-nik">Tanggungan
                                            Keluarga</label>
                                        <input type="number" class="form-control" id="personal-data-nik" name="tanggungan" placeholder="Masukkan jumlah tanggungan" value="{{ old('tanggungan') }}">
                                        @error('tanggungan')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Upload</span>
                                            <div class="form-file">
                                                <input type="file" class="form-file-input form-control" name="ftgaji" value="{{ old('ftgaji') }}">
                                            </div>
                                        </div>
                                        @error('ftgaji')
                                        <div class="alert alert-warning" role="alert">
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Upload</span>
                                            <div class="form-file">
                                                <input type="file" class="form-file-input form-control" name="ftkk" value="{{ old('ftkk') }}">
                                            </div>
                                        </div>
                                        @error('ftkk')
                                        <div class="alert alert-warning" role="alert">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        <label class="form-label" for="billing-address">Nama
                                            Sekolah</label>
                                        <input class="form-control" list="datalistOptionsSekolah" id="exampleDataList" placeholder="Cari NPSN Sekolah...." name="id_sekolah" value="{{ old('id_sekolah') }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input class="form-control" list="datalistOptionsJurusan" id="exampleDataList" placeholder="Cari Jurusan..." name="jurusan" value="{{ old('jurusan') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" name="smt1" placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt1') }}">
                                        @error('smt1')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" name="smt2" placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt2') }}">
                                        @error('smt2')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-2">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" name="smt3" placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt3') }}">
                                        @error('smt3')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" name="smt4" placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt4') }}">
                                        @error('smt4')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-2">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <input type="number" class="form-control" name="smt5" placeholder="Masukkan Rata Nilai Semester" value="{{ old('smt5') }}">
                                        @error('smt5')
                                        <div class="alert alert-warning" role="alert">
                                            <strong>Peringatan!</strong>
                                            {{ $message }}
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Upload</span>
                                            <div class="form-file">
                                                <input type="file" class="form-file-input form-control" name="ftraport" value="{{ old('ftraport') }}">
                                            </div>
                                        </div>
                                        @error('ftraport')
                                        <div class="alert alert-warning" role="alert">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Upload</span>
                                            <div class="form-file">
                                                <input type="file" class="form-file-input form-control" name="ftprestasi" value="{{ old('ftprestasi') }}">
                                            </div>
                                        </div>
                                        @error('ftprestasi')
                                        <div class="alert alert-warning" role="alert">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3 mb-4">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">Upload</span>
                                            <div class="form-file">
                                                <input type="file" class="form-file-input form-control" name="ftijazah" value="{{ old('ftijazah') }}">
                                            </div>
                                        </div>
                                        @error('ftijazah')
                                        <div class="alert alert-warning" role="alert">
