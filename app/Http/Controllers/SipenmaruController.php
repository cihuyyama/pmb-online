...
class SipenmaruController extends Controller
{
    ...
    public function dashboard(){
        ...
        $prodi = Prodi::all();
        return view ('dashboard',['timeline' => $timeline,'viewDataUser' => $dataUser,'viewTotal'=>$data,'pendaftar'=>$pendaftar,'jmlpengumuman'=>$jmlpengumuman,'jmlpendaftar'=>$jmlpendaftar,'jmluser'=>$jmluser,'prodi'=>$prodi,'jmlbayar'=>$jmlbayar]);
    }
    //profil
